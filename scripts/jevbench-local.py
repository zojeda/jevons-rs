...
def main():
    ...
    parser.add_argument("--think-decoding",
                        choices=["diffusion", "self-speculation", "autoregressive"],
                        help="Server --think-decoding (default: the server's, diffusion)")
    ...
    if args.think_decoding:
        command += ["--think-decoding", args.think_decoding]
