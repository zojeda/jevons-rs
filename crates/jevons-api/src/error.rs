...
impl From<crate::openai::OpenAiError> for ApiError {
    fn from(error: crate::openai::OpenAiError) -> Self {
        Self {
...
impl ApiError {
    ...
    pub fn openai(self) -> Self {
        ...
        Self {
            status: self.status,
            body: crate::openai::OpenAiError::new(self.status.as_u16(), kind, message).body(),
        }
    }
}
